...
- [x] Tests hooks frontend custom — `useClientsSelection.test.ts` 8 tests + `useCollapsedGroups.test.ts` 7 tests (toggle, persist localStorage, JSON corrompu, groupes indépendants) — ~2h
