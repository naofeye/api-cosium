...
export default function LoginPage() {
  ...
  // No disabled gating — handleSubmit validates via Zod on submit.
  // watch() doesn't react reliably to Playwright's fill() in CI,
  // so we let the form submit and show validation errors if needed.
        ...
        <div className="rounded-2xl border border-white/10 bg-white/95 backdrop-blur-xl p-8 shadow-2xl ring-1 ring-black/5">
          ...
          {!mfaRequired && (
            ...
            >
              ...
              <Button type="submit" loading={isSubmitting} className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-500/25 transition-all duration-200">
                Se connecter
              </Button>
